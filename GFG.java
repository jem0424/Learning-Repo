import java.util.*;
/*Program gets integer from array. Compares to null puts if its the initial value.
...
public class GFG {
	...
	static void createHashMap(int arr[]) {
		HashMap<Integer, Integer> hmap =new HashMap<Integer, Integer>();// instantiate HashMap
